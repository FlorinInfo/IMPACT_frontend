...
const Homepage = () => {
  ...
  useEffect(() => {
    axios
      .get(`/articles?${zone.type}=${zone.id}&${filter}=true&offset=0&limit=10&cursor=`,
        {
          headers: {
    ...
    <div className="homepage">
      <div className="homepage__container">
        <div className="homepage__left">
          ...
          {
            posts.map((article)=> <div key={article.id} className="homepage__post"><Post  article={article} /> </div>)
          }
          </div>
        </div>
