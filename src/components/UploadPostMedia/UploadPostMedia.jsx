...
const UploadPostMedia = ({getImages, getVideos}) => {
	...
	return (
		<div className="media-post">
			<input className="media-post__input-upload" onChange={uploadFile} accept="video/*, image/*" type="file" ref={fileInput} />
			<div className="media-post__grid">
				...
				<div className="media-post__add-btn" onClick={openUploadMedia}>
					{
						loading == false ? <IoAdd className="media-post__add-icon" />
							: <HashLoader className="media-post__loader" color={color} loading={loading} css={override} size={60} />
					}
				</div>
			</div>
